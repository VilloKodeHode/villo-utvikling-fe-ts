...
import { ThemedH1, ThemedH2, ThemedP } from '@components/atoms/ThemedText';
...
export const ContactformSection = ({ content }) => {
  ...
  return (
    <section className="px-4 grid max-w-4xl mx-auto sm:px-6 lg:px-8 min-h-[calc(100vh-144px)] place-items-center">
      {!showModal ? (
        <div className="w-full animate-PageAppearRight">
          <ThemedH1 className="mb-4 text-center">{content.heading}</ThemedH1>
          <ThemedP className="mb-6 text-center">{content.description}</ThemedP>
        ...
        <div className="flex items-center justify-center w-full">
          <div className="relative flex flex-col items-center justify-center gap-8 p-8 rounded-3xl bg-light-mist dark:bg-dark-onyx shadow-xl max-w-xl">
            <ThemedH2 className="text-center">{content.thankYouHeading}</ThemedH2>
