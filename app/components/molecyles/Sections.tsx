  ...
  return (
    ...
    className="flex flex-col max-w-7xl gap-10 justify-center text-center items-center min-h-screen">
      ...
      <div className="animate-PageAppearRight">
        <div
          className={`sm:rounded-lg grid min-h-[70dvh] lg:grid-cols-2 transition-colors duration-1000 glass-morphism-section`}
        >
          <div
          ...
          >
            ...
            <ThemedP className="max-w-md px-8 pb-5">{content?.paragraph}</ThemedP>
          </div>
