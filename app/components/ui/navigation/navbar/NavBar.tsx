  ...
  return (
    <>
      <div className="relative">
        <div
          className={`flex z-100 w-full px-2 sm:px-4 lg:px-8 h-[112px] justify-between items-center glass-morphism-plain border-t-[1px] border-light-cloud dark:border-dark-slate overflow-x-hidden `}
        >
        ...
        <HamburgerBar params={{ lang }} menuItems={menuItems} />
      </div>
    </>
  );
};
